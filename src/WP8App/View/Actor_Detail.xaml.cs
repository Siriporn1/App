...
{
    /// <summary>
    /// Phone application page for Actor_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Actor_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Actor_Detail and all its components.
        /// </summary>
        public Actor_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaActor_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaActor_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaActor_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaActor_Detail(PanoramaActor_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaActor_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IActor_charactersCollection>();
				AddHomeAppBarButton();
				...
				((IViewModels.IActor_DetailViewModel)DataContext).CurrentcharactersSchema = pinnedItem;				
			}
		}
