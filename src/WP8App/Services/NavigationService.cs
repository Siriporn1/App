...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.Istart_ListViewModel), "/View/start_List.xaml" },
            { typeof(IViewModels.IMovie_DetailVideosViewModel), "/View/Movie_DetailVideos.xaml" },
            { typeof(IViewModels.ITheStory_InfoViewModel), "/View/TheStory_Info.xaml" },
            { typeof(IViewModels.IEpisode_EpisodeViewModel), "/View/Episode_Episode.xaml" },
            { typeof(IViewModels.IActor_ActoractorViewModel), "/View/Actor_Actoractor.xaml" },
            { typeof(IViewModels.IActor_DetailViewModel), "/View/Actor_Detail.xaml" },
