...
namespace WPAppStudio.ViewModel
{
    ...
    {       
        ...
        {
			_title = @"Twilight";
			_description = @"Twilight is a 2008 American romantic fantasy film based on Stephenie Meyer's popular novel of the same name. Directed by Catherine Hardwicke, the film stars Kristen Stewart and Robert Pattinson. It is the first film in The Twilight Saga film series."; 
			_version = "v1";
			_appLink = "https://apps.windowsstore.com/DashBoard/DownloadAppXap?appId=1ef23958-8a3a-45be-90b3-be5a902a17e6";
