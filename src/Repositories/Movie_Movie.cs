...
namespace WPAppStudio.Repositories
{
    ...
    public class Movie_Movie : IMovie_Movie 
    {
		...
		private const string YoutubeQuery = @"OfficialTwilightFilm";

        /// <summary>
        /// Initializes a new instance of the <see cref="Movie_Movie" /> class.
        /// </summary>
        /// <param name="youtubeDataSource">A Youtube data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Movie_Movie(RepositoriesBase.IYoutubeDataSource youtubeDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: OfficialTwilightFilm ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: OfficialTwilightFilm ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
		...
		/// <summary>
        /// Retrieves the data from Youtube (channel: OfficialTwilightFilm ), filtered by a filter specification, in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        {
			var data = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Movie_Movie");
        ...
        {
			var storedItems = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Movie_Movie");
            ...
            if (_internetService.IsNetworkAvailable() && (pageNotSaved || forceRecaching))
            {
                ...
                if(newItems != null && newItems.Any())
				{
					...
					_storageService.Save("Movie_Movie", new ObservableCollection<EntitiesBase.YouTubeVideo>(storedCollection));
				}
			}
