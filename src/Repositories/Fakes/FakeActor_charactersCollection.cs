...
{
    /// <summary>
    /// Fake charactersSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeActor_charactersCollection : IActor_charactersCollection 
    {
        ...
        public ObservableCollection<Entities.charactersSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.charactersSchema> 
			{ 
			...
			return new ObservableCollection<Entities.charactersSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.charactersSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of charactersSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.charactersSchema>.FilterCollection(filter, GetData());
        }
