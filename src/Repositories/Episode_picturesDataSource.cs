...
namespace WPAppStudio.Repositories
{
    ...
    public class Episode_picturesDataSource : IEpisode_picturesDataSource 
    {
		...
		private const string RssUrl = "http://www.twilightnewborns.com/feed/podcast/";

        /// <summary>
        /// Initializes a new instance of the <see cref="Episode_picturesDataSource" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Episode_picturesDataSource(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://www.twilightnewborns.com/feed/podcast/), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("Episode_picturesDataSource", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("Episode_picturesDataSource");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://www.twilightnewborns.com/feed/podcast/), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
